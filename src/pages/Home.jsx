...
const HomeContainer = styled.div`
  ...
  padding: 50px 20px;
  background-color: var(--background-color, #f9f9f9);  // Use global background color
  min-height: 100vh;
`;

// Styled heading for the page
const Heading = styled.h1`
  color: var(--primary-color, #4CAF50);  // Use global primary color for emphasis
  font-size: 3rem;
  margin-bottom: 20px;
  text-align: center;
`;
...
const Paragraph = styled.p`
  ...
  max-width: 800px;
  margin-top: 20px;
  color: var(--text-color, #555);  // Use global text color
`;
